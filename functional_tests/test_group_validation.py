...
class ValidationTest(FunctionalTest):	
	...
	def test_wrong_user_input(self):
		...
		self.assertEqual(self.browser.find_element_by_id('id_group_tags').text, "b; c")
		...
		self.assertEqual(self.browser.find_element_by_id('id_group_name').text, "Pessoas mais chatas")
		self.assertEqual(self.browser.find_element_by_id('id_group_alias').text, "chatos")
		self.assertEqual(self.browser.find_element_by_id('id_group_tags').text, "tag_igual; tag_igual")
		self.assertEqual(self.browser.find_element_by_id('id_group_description').text, "Nao sei")
